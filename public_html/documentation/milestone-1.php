<!DOCTYPE html>
	...
	<body>
		<section>
			<h1>Purpose</h1>
			<p> The Medical Cannabis Advocate site comes to life with the purpose to educate and raise awareness on the benefits of medical cannabis, specifically the cannabinoid CBD: cannabidiol and how important and succesful it is in treating a condition called: Dravet Syndrome. </p>
		</section>

		<section>
			<h1> Audience </h1>
			<p> The site will be beneficial for everyone but it's main focus will be to reach families or parents of children suffering from Dravet Syndrome or any other type of seizure disorders and provide them with a site they can visit and get educational material on the use of Rick Simpson Oil to treat this devilitating condition. It will also provide information on the current states that currently participate or have a medical cannabis program and the specific laws governing such program.</p>
		</section>
		...
		<section>
			...
			<ul>
				...
				<li>Provide information on support groups.</li>
			</ul>
		</section>
